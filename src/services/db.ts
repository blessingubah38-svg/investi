...
export let isFirebaseReady = firebaseConfig.apiKey && firebaseConfig.apiKey !== 'placeholder-api-key' && localStorage.getItem('force_local_fallback') !== 'true';

export function toggleFirebaseReady(ready: boolean) {
