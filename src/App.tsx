...
import hero_man_tablet from './assets/images/hero_man_tablet_1779995294194.png';
import hero_woman_phone from './assets/images/hero_woman_phone_1779995309843.png';
import about_team from './assets/images/about_team_1779995328220.png';
import faq_man from './assets/images/faq_man_1779995352650.png';
import about_woman_tablet from './assets/images/about_woman_tablet_1779995376101.png';
import about_cash from './assets/images/about_cash_1779995392829.png';
import about_wallet from './assets/images/about_wallet_1779995414284.png';
import about_coins from './assets/images/about_coins_1779995433183.png';
    ...
    const unsubscribe = onAuthStateChanged(auth, async (firebaseUser) => {
      if (firebaseUser) {
        try {
          ...
          console.warn("Auth restore error handled seamlessly: ", err);
        }
      }
    });
    return () => unsubscribe();
